...
class Quarto:
    def __init__(self, numero, andar, quantidade_hospedes, preco):
        self.numero = numero
        self.andar = andar
...
class Hotel:
    ...
    def quartos_disponiveis(self, quantidade_hospedes):
        return sorted(
          [
            quarto
            for quarto in self.quartos
            if not quarto.reservado and
            quantidade_hospedes <= quarto.quantidade_hospedes
          ],
          key=attrgetter('quantidade de hospedes')
        )
